...
class LogMergerApp:
    def __init__(self, root):
        ...
        # Set custom icon
        #try:
        #    self.root.iconbitmap("./icon/icon002.ico")
    ...
    def merge_logs(self):
        ...
        for file_path in self.loaded_files:
            ...
            # Extract service name between hostname and capitalized service name
            match = re.search(r'[^-]+\-([a-z]+)(?=\.[A-Z])', file_name, re.IGNORECASE)
